...
As @tbl-anscombe shows, all four of the different datasets show the same means, variances, and correlations (more on that in chapter @sec-cor). With *just* these summary statistics, you'd likely think "eh, all the data is the same, these datasets are basically identical."
