...
You can learn more about the framework and how it can be implemented in the classroom here: [***The Accidental Author: An Implementation Guide***](https://martinezc1-the-accidental-author.share.connect.posit.cloud/)

A condensed overview is also available here: [***The Accidental Author: At a Glance***](https://martinezc1-the-accidental-author--at-a-glance.share.connect.posit.cloud/)
...
You can explore the collection here: [**Student Portfolio Book**](https://martinezc1-reproducible-research-using-r--student-work-in-pract.share.connect.posit.cloud/) @Martinez_Student_Portfolio_2026.
...
You can explore the full collection of student projects here: [**NYC Open Data Student Gallery**](https://martinezc1-nyc-open-data-student-gallery.share.connect.posit.cloud/) @Martinez_NYC_Open_Data_2026.
...
- 📖 [Read the companion textbook](https://martinezc1-teaching-reproducible-research-using-r.share.connect.posit.cloud/)
