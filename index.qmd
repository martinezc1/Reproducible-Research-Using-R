...
The `reproresearchR` (@R-reproresearchR) package also includes two versions of each chapter’s R script:
...
This textbook is part of a broader reproducible research initiative built around real civic data. Students at Brooklyn College used the workflow outlined in this book to conduct original research projects using datasets from [New York City’s Open Data portal](https://opendata.cityofnewyork.us/) @Martinez_NYC_Open_Data_2026. 
